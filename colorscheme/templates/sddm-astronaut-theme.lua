...
Background="Backgrounds/greet.jpg"
# Must be a relative path.
...
LoginFieldBackgroundColor="${bg}"
PasswordFieldBackgroundColor="${bg}"
LoginFieldTextColor="${fg}"
PasswordFieldTextColor="${fg}"
UserIconColor="${fg}"
PasswordIconColor="${fg}"

PlaceholderTextColor="${fg_dark}"
WarningColor="${dark2}"

LoginButtonTextColor="${fg}"
LoginButtonBackgroundColor="${bg_highlight}"
SystemButtonsIconsColor="${fg_dark}"
SessionButtonTextColor="${fg_dark}"
VirtualKeyboardButtonTextColor="${fg_dark}"

DropdownTextColor="${fg}"
DropdownSelectedBackgroundColor="${bg_highlight}"
DropdownBackgroundColor="${bg_dark1}"

HighlightTextColor="${accent}"
HighlightBackgroundColor="${bg_highlight}"
HighlightBorderColor="${bg_highlight}"
